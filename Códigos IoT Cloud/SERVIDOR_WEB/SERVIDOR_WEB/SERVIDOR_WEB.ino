...
char ssid[] = "Mi 10T";                    //  your network SSID (name) between the " "
char pass[] = "Agualanjaron1";                   // your network password between the " "
...
void printWifiStatus() {
  ...
  carrier.display.println("  JULIO  -  ADRIAN");
...
void connect_WiFi() {
  ...
  while (status != WL_CONNECTED) {
    ...
    carrier.display.println("Esperando Conexion ...");
 ...
 //moisture
  ...
  //print moist level in plant
          //  client.println("<i class='fas fa-tree'></i>");
            client.print("SERVIDOR WEB JULIO Y ADRI ");
          ...
          //  client.print(" %");
            ...
            client.print("La luminosidad es de: ");
            client.print(light);
            client.print(" LUX");
            client.println("<br><br>");
            ...
            client.print("Quieres o apagar o encender el rele ");
